...
go build -o %GOPATH%/bin/hms.win.x64.exe -v -ldflags="-linkmode external -extldflags -static -X 'github.com/schwarzlichtbezirk/hms/cfg.BuildVers=%buildvers%' -X 'github.com/schwarzlichtbezirk/hms/cfg.BuildTime=%buildtime%'" %wd%/cmd
